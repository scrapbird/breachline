...
replace github.com/scrapbird/breachline/infra/sync-api/src/api => ../infra/sync-api/src/api
...
require (
	...
	github.com/scrapbird/breachline/shared/types v0.0.0-00010101000000-000000000000
)
