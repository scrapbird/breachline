module workspace-convert-to-shared

go 1.23.0

require (
	github.com/aws/aws-lambda-go v1.50.0
	github.com/scrapbird/breachline/infra/sync-api/src/api v0.0.0-00010101000000-000000000000
)
...
require (
	...
	github.com/scrapbird/breachline/shared/types v0.0.0-00010101000000-000000000000 // indirect
)

replace github.com/scrapbird/breachline/infra/sync-api/src/api => ../../api

replace github.com/scrapbird/breachline/shared/types => ../../../../../shared/types
